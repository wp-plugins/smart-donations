...
<a target="_blank" href="<?php REDNAO_URL?>SmartDonations.php"> <img id="smartDonationsImageClassic" src="<?php echo plugin_dir_url(__FILE__)?>images/analitics-pro.png" alt="" width="760" height="760"></a>
