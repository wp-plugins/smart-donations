...
smartdonationsGoalBar.prototype.DonationGeneratedCode=function(){
    ...
    if(this.orientation=='h')
    {
        return '<div style="text-align: center;clear:both;">\
            <div>\
            <div class="thermometer horizontal smartDonationsEditableItem" style="background: rgb(247,247,247);display: inline-block;width: 350px;height: 70px;position: relative;border-radius: 33px 17px 46px 17px;-moz-border-radius: 33px 17px 46px 17px;-webkit-border-radius: 33px 17px 46px 17px;border: 0px solid #800000;background: -moz-linear-gradient(top,  rgba(247,247,247,1) 0%, rgba(241,241,241,1) 50%, rgba(225,225,225,1) 51%, rgba(246,246,246,1) 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,rgba(247,247,247,1)), color-stop(50%,rgba(241,241,241,1)), color-stop(51%,rgba(225,225,225,1)), color-stop(100%,rgba(246,246,246,1)));background: -webkit-linear-gradient(top,  rgba(247,247,247,1) 0%,rgba(241,241,241,1) 50%,rgba(225,225,225,1) 51%,rgba(246,246,246,1) 100%);background: -o-linear-gradient(top,  rgba(247,247,247,1) 0%,rgba(241,241,241,1) 50%,rgba(225,225,225,1) 51%,rgba(246,246,246,1) 100%);background: -ms-linear-gradient(top,  rgba(247,247,247,1) 0%,rgba(241,241,241,1) 50%,rgba(225,225,225,1) 51%,rgba(246,246,246,1) 100%);background: linear-gradient(to bottom,  rgba(247,247,247,1) 0%,rgba(241,241,241,1) 50%,rgba(225,225,225,1) 51%,rgba(246,246,246,1) 100%);filter: progid:DXImageTransform.Microsoft.gradient( startColorstr=\'#f7f7f7\', endColorstr=\'#f6f6f6\',GradientType=0 );" >\
