...
smartDonationsWePayProvider.prototype.GetStartOfDonationForm=function(generator,defaultQuantity)
{
    ...
    if(this.FixedAmount)
        return  '<a class="wepay-widget-button wepay-green smartDonationsWePayButton" '+(this.hide?' style="display:none;" ':'')+' id="wepay_widget_anchor_'+this.anchor+'" href="https://www.wepay.com/donations/'+auxBusiness+'">'+this.ButtonText+'</a><script type="text/javascript">var WePay = WePay || {};WePay.load_widgets = WePay.load_widgets || function() { };WePay.widgets = WePay.widgets || [];WePay.widgets.push( {object_id: '+auxBusiness+',widget_type: "donation_campaign",anchor_id: "wepay_widget_anchor_'+this.anchor+'",widget_options: {donation_amount: '+defaultQuantity*100+',allow_cover_fee: true,enable_recurring: true,allow_anonymous: true,button_text: "casa $10.00"}});if (!WePay.script) {WePay.script = document.createElement(\'script\');WePay.script.type = \'text/javascript\';WePay.script.async = true;WePay.script.src = \'https://static.wepay.com/min/js/widgets.v2.js\';var s = document.getElementsByTagName(\'script\')[0]; s.parentNode.insertBefore(WePay.script, s);} else if (WePay.load_widgets) {WePay.load_widgets()}</script>'
    else
