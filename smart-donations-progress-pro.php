...
<a target="_blank" style="display: block; font-size: 20px; font-weight: bold; margin-top:5px;margin-bottom:10px;" href="<?php REDNAO_URL?>SmartDonations.php">Learn More</a>
</div>
...
<a target="_blank" href="<?php REDNAO_URL?>SmartDonations.php"> <img id="smartDonationsImageClassic" src="<?php echo plugin_dir_url(__FILE__)?>images/addNewProgressPro.png" alt="" width="760" height="760"></a>
