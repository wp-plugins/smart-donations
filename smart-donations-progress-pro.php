...
wp_enqueue_script('smart-donations-pro',plugin_dir_url(__FILE__).'js/smart-donations-pro','isolated-slider');
?>

<div style="display: inline-block">
<p>The progress indicators are a pro feature, you can unlock them here:</p>
<a target="_blank" style="display: block; font-size: 20px; font-weight: bold; margin-top:5px;margin-bottom:10px;" href="<?php REDNAO_URL?>smartdonations.html">Learn More</a>
</div>
...
<a target="_blank" href="<?php REDNAO_URL?>smartdonations.html"> <img id="smartDonationsImageClassic" src="<?php echo plugin_dir_url(__FILE__)?>images/addNewProgressPro.png" alt="" width="760" height="760"></a>
